...
import kr.ac.tukorea.rudy.projectdlc.game.MainScene;

public class ProjectDlcActivity extends GameActivity {
    ...
    public void endGame(int index, String diff) {
    ...
    public void restartGame(int songIndex, String songDiff) {
        Intent intent = new Intent(this, ProjectDlcActivity.class);
        intent.putExtra(ProjectDlcActivity.SONG_INDEX, songIndex);
        intent.putExtra(ProjectDlcActivity.SONG_DIFFICULTY, songDiff);
        startActivity(intent);
    }
}